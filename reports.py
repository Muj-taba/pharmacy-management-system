...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(130, 10, 461, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(Form)
        self.pushButton.setGeometry(QtCore.QRect(80, 150, 91, 31))
        self.pushButton.setObjectName("pushButton")
        self.tableWidget = QtWidgets.QTableWidget(Form)
        self.tableWidget.setGeometry(QtCore.QRect(0, 210, 771, 321))
...
"}")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(200, 150, 291, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.comboBox = QtWidgets.QComboBox(Form)
        self.comboBox.setGeometry(QtCore.QRect(528, 150, 91, 31))
        self.comboBox.setObjectName("comboBox")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.tableWidget_2 = QtWidgets.QTableWidget(Form)
        self.tableWidget_2.setGeometry(QtCore.QRect(0, 210, 771, 321))
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Reports"))
        self.label.setText(_translate("Form", "This is an empty reports Widget / It\'s not ready yet"))
        self.pushButton.setText(_translate("Form", "Search"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "mi_id"))
        ...
        item.setText(_translate("Form", "customer_name"))
        item = self.tableWidget_2.horizontalHeaderItem(2)
        item.setText(_translate("Form", "doctor_name"))
        item = self.tableWidget_2.horizontalHeaderItem(3)
        item.setText(_translate("Form", "hospital_name"))
